...
# ============================================================
# For training & validation, we use augmentation (except rescaling is common).
...
# Build the final model by appending custom layers
model = Sequential()
model.add(basemodel)
...
# Fit (train) the model. Note: steps_per_epoch and validation_steps are omitted to use the generator defaults.
history = model.fit(
    train_generator,
    epochs=n_epochs,
